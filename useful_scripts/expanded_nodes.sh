...
#This script returns the expanded nodes provided in the last f-layer of a heuristic evaluation for solved problems on each configuration provided to the script.
